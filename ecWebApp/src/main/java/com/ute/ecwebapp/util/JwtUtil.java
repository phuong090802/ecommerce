...
import com.ute.ecwebapp.dto.JwtTokenDTO;
...
public class JwtUtil {
	...
	public String generateAccessToken(AccountEntity accountEntity) {
		return Jwts.builder().setSubject(accountEntity.getAccountName()).setIssuer(jwtIssuer)
	...
	public JwtTokenDTO getJwtTokenDTO(String token) {
		...
		return JwtTokenDTO.builder().subject(claims.getSubject()).expirationDate(claims.getExpiration())
