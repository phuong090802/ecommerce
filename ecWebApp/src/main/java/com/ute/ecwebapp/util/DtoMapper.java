...
public class DtoMapper {
	...
	public String convertToString(String json, String key) throws JsonMappingException, JsonProcessingException {
		JSONObject jsonObject = new JSONObject(json);
		return jsonObject.getString(key);
	}

	public AddressDto convertToAddressDto(String json) throws JsonMappingException, JsonProcessingException {
