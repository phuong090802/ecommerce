...
public class DownloadImage {
	...
	@GetMapping("/itemAuction/{itemAuctionId}/photo{photoId}")
	public ResponseEntity<?> downloadImage(@PathVariable Integer itemAuctionId, @PathVariable Integer photoId) {
		...
		var photoEntity = photoService.getByitemAuctionEntityAndPhotoId(itemAuctionEntity, photoId);
